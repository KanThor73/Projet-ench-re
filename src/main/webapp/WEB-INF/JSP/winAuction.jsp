		...
		<div class="container">
			<c:choose>
				<c:when test="${delete != null}">
					<div class="msgBox">
						<p>
							...
							<br> Aucun acheteur, votre article va être retiré.
						</p>
						<form
							action="<%=request.getContextPath()%>/FinEncheres?id=<%=request.getParameter("id")%>"
							method="post">
				...
				<c:when test="${proprio != null}">
					<div class="msgBox">
						<p>
							La date de fin d'enchères est atteinte.<br> <br> En
							attente du retrait par ${contactPseudo}.
						</p>
					</div>
					<div class="contact">
						<h3>Contact :</h3>
				...
				<c:when test="${winner != null}">
					<div class="msgBox">
						<p>
							Vous avez remporté cette enchère !<br> <br> Veuillez
							retirer l'article à : ${rue}, ${codePostal} ${ville}.<br>
						</p>
