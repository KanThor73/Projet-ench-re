					...
					<div class="formContainer">
						<div class="formBody">
							...
							<div class="formFragment">
								...
								<input type="text" name="postal" id="postal" size="30" required>
							</div>
							<div class="formFragment">
							...
							<div class="formFragment">
								...
								<input type="password" name="mdp2" id="mdp2" size="30" required>
							</div>
						</div> <!-- formBody / Corps formulaire -->
						<div class="formFooter">
							<input type="submit" value="Modifier">
							<div class="button">
								<a href="<%=request.getContextPath()%>">Supprimer un compte</a>
							</div>
=======
<link href="style/newAccount.css" rel="stylesheet">
<title>Modifier Profil</title>
...
>>>>>>> branch 'main' of https://github.com/KanThor73/Projet-ench-re.git
						</div>
					</div>
