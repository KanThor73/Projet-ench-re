...
public class NewAccountServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			User user = userMgr.selectByPseudo(pseudo);
			...
			if (!(mdp).equals(mdp2)) {
				...
				User newUser = new User(pseudo, nom, prenom, email, telNum, rue, codePoste, ville, mdpTab[0], false, mdpTab[1]); // pas administrateur
